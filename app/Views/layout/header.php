...
$role = session('role') ?? env('app.defaultRole', 'Commissaire');
...
/competitions/4387
/competitions/4387/photos
/competitions/4387/jugement
/jugement/...
*/

if (isset($segments[0]) && $segments[0] === 'competitions' && isset($segments[1])) {

    $competitionId = $segments[1];

    session()->set('competition_id', $competitionId);
} else {
